        ...
        <div class="chat_box">
                ...
                <div class="online_box" @click="morebox_show=0,feedback_show=0">
                    <div class="search_box">
                        <div class="search_bar">
                            <input type="text" placeholder="搜索" @focus="search" @focusout="search_flag=0"
                                   :class="{'focus':search_flag}" v-model="search_text"/>
                            <div class="add">+</div>
                            <div class="search_icon"></div>
                        </div>
                    </div>
                    <ul class="online_list">
                        <li v-for="(item,index) in filterName" @click="chooseChat(index)"
                            :class="[{'top':index==0},{'current':currentChat==index}]">
                            <div class="info">
                                <div class="user_head"><img :src="'static/headimg/'+item.userhead"/><span class="fubiao"
                                                                                                          v-show="item.fubiao_flag"></span>
                                </div>
                                <div class="user_info">
            ...
            <div class="panel_right" @click="feedback_show=0">
                ...
                <div class="msg_box" id="msgbox">
                    ...
                    <div v-for="(item,index) in curRoom"
                         :class="['other_msg',{'my_msg':myName==curRoom[index].username}]">
                ...
                <div :class="['send_box',{'focus':write_flag}]">
                    ...
                    <textarea v-model="myMsg" class="text_box" @focus="write_flag=1"
                              @focusout="write_flag=0"></textarea>
...
export default {
    ...
    methods: {
        ...
        more_record () {
            socket.emit('pagecount', {
                pagecount: this.pagecount,
                socketid: this.socketid,
                curnum: this.msg_list.length
            });
            this.pagecount++;
        },
        formatDate (now) {
